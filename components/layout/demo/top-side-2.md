...
<template>
  <atu-layout>
    ...
    <atu-layout hasSider>
      <atu-sider>
        <atu-menu mode="inline" style="height:100%;border-right:0;" :defaultOpenKeys="['sub1']" :defaultSelectedKeys="['1']">
      ...
      <atu-layout style="padding: 0px 24px 24px">
        ...
        <atu-content style="background: #fff; padding: 24px; min-height: 280px">
          <div>Content</div>
        </atu-content>
      </atu-layout>
    </atu-layout>
